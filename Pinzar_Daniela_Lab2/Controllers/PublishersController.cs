...
namespace Pinzar_Daniela_Lab2.Controllers
{
    public class PublishersController : Controller
    {
        ...
        public async Task<IActionResult> Index(int? id, int? bookID)
        {
            ...
            viewModel.Publishers = await _context.Publishers.Include(i => i.PublishedBooks).ThenInclude(i => i.Book).ThenInclude(i => i.Orders).ThenInclude(i => i.Customer).AsNoTracking().OrderBy(i => i.PublisherName).ToListAsync();
